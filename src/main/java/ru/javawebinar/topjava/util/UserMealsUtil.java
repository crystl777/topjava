...
public class UserMealsUtil {
    ...
    private static void recursiveCalculationSumCalories(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, List<UserMealWithExcess> mealsWithExcesses,
                                                        Map<LocalDate, Integer> caloriesSumPerDate, int index, int caloriesPerDay) {
        if (index < meals.size()) {
    ...
    private static void addMealsWithExcess(UserMeal meal, LocalDateTime localDateTime, LocalTime startTime, LocalTime endTime, List<UserMealWithExcess> mealsWithExcesses,
                                           Map<LocalDate, Integer> caloriesSumPerDate, int caloriesPerDay) {
